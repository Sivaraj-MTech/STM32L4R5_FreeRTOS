...
#define RED GPIO_PIN_13
#define GREEN GPIO_PIN_14
#define ORANGE GPIO_PIN_15
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, GPIO12_Pin|GPIO13_Pin|GPIO14_Pin|GPIO15_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : GPIO12_Pin GPIO13_Pin GPIO14_Pin GPIO15_Pin */
  GPIO_InitStruct.Pin = GPIO12_Pin|GPIO13_Pin|GPIO14_Pin|GPIO15_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
